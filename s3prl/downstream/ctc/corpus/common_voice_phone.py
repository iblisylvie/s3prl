...
from multi_lingual_phonemizer import Phonemizer

class CommonVoicePhoneDataset(Dataset):
    def __init__(
        self,
        split,
        tokenizer,
        ...
        **kwargs,
        ...
        # check phoneme availability
        phonemizer = Phonemizer(lexicon)

        for p in phonemizer.get_phoneme_set():
        ...
        for s in split:
            with open(s, "r") as fp:
                ...
                for i, row in enumerate(rows):
                    ...
                    text.append(tokenizer.encode(phonemizer(row[1])))
